...
class Test:
    ...
    def run(self, *values, **options):
        ...
        if values[0] == "0049": print(Array._0049_group_anagrams(**options))
        if values[0] == "0088": Array._0088_merge_sorted_array(**options); print(options["nums1"])
        if values[0] == "0121": print(Array._0121_best_time_buy_sell_stock(**options))
        if values[0] == "0122": print(Array._0122_best_time_buy_sell_stock_II(**options))
